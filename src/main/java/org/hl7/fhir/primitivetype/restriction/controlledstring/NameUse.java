...
public enum NameUse {
	...
	USUAL,
	/**
	 * The formal name as registered in an official (government) registry, but
	 * which name might not be commonly used. May be called "legal name".
	 */
	OFFICIAL,
	/**
	 * A temporary name. Name.period can provide more detailed information. This
	 * may also be used for temporary names assigned at birth or in emergency
	 * situations.
	 */
	TEMP,
	/**
	 * A name that is used to address the person in an informal manner, but is
	 * not part of their formal or usual name
	 */
	NICKNAME,
	/**
	...
	OLD,
	/**
	 * A name used prior to marriage. Marriage naming customs vary greatly
	 * around the world. This name use is for use by applications that collect
	 * and store "maiden" names. Though the concept of maiden name is often
	 * gender specific, the use of this term is not gender specific. The use of
	 * this term does not imply any particular history for a person's name, nor
	 * should the maiden name be determined algorithmically.
	 */
	MAIDEN;

	public static NameUse fromCode(@NonNull String codeString) throws Exception {

...
public enum ContactentityType {
	...
	ADMIN,
	/**
	 * Contact details for issues related to Human Resources, such as staff
	 * matters, OH&S etc.
	 */
	HR,
	/**
	 ...
	 */
	PRESS;
	public static ContactentityType fromCode(@NonNull String codeString) throws Exception {
